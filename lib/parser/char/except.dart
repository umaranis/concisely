...
class NotCharParser extends CharBaseParser{
  ...
  @override
  String get label => '"except(${toReadableString(charCode)})"';
...
class NotCharRangeParser extends CharBaseParser {
  ...
  @override
  String get label => '"except(${toReadableString(String.fromCharCode(startChar))}-${toReadableString(String.fromCharCode(endChar))})"';
